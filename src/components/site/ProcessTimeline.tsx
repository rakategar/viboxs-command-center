          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="lg:mt-5">
                <h3 className="font-display text-lg sm:text-xl lg:text-base font-semibold text-foreground">
                  {s.title}
                </h3>
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground line-clamp-3 group-hover:line-clamp-none">
                  {s.body}
                </p>
              </div>
            </li>
